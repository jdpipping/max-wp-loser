...
The piecewise CDF in Supplementary Section~S3 gives the selected values in Table~\ref{tab:supp-numerical-benchmarks}.
...
Intervals and $p$-values in Sections~S5--S7 use $B=\DyadicBootstrapReplicates$ season-stratified dyadic draws with seed \DyadicBootstrapSeed.
...
Section~S8 evaluates finite-sample size on the observed schedules, and the franchise-linked specification in Table~\ref{tab:supp-specification} carries team effects across seasons.
...
\begin{minipage}[t]{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figures/nfl/fixed_clock_surface_linear.png}
  \\[-0.2em]{\small (a) NFL, linear interpolation}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figures/nba/fixed_clock_surface_linear.png}
  \\[-0.2em]{\small (b) NBA, linear interpolation}
\end{minipage}\\[0.8em]
\begin{minipage}[t]{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figures/nfl/fixed_clock_surface_locf.png}
  \\[-0.2em]{\small (c) NFL, LOCF}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figures/nba/fixed_clock_surface_locf.png}
...
The simulation targets finite-schedule size under shared-team dependence; calendar and cross-season dependence are examined through the sensitivities in Section~S7.
